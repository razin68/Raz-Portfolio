    ...
    >
      <Link href={`/work/${project.slug}`} className="group block [perspective:1200px]">
        ...
        >
          ...
          >
            <span className="flex items-center gap-2 text-xs font-medium tracking-widest uppercase text-[#1A1714]/70 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300">
              View case study
