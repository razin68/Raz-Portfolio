...
// Employer named with permission: University of Rochester Medical Center (URMC).
export const projects: Project[] = [
  {
    ...
    reflection: [
      ...
      {
        title: "Track the dependencies you don't own",
        body:
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        statsTop: true,
        body:
          "Provider search was the framework's first real test, and the reason it exists. The team had no shortage of proposed fixes. It just couldn't prove any of them, and I needed each assumption validated or rejected against real evidence.\n\nOld research handed over themes and quotes, easy to argue with and impossible to rank. The framework turns every session into a number instead.\n\nWEIGHTED IMPACT SCORE = Sentiment × Severity\n\nSentiment is direction, scored −3 to +3: did this help the user or hurt them? I read it from the whole interview, the tone, the expression, the body language, the small hesitations, not just the words. Severity, scored 1 to 3, is how much it mattered. Multiply the two, and every observation carries a single weighted score that rolls up to the hypothesis it tested.",
        flow: [
          {
            step: "01",
        ...
        hypotheses: [
          {
            ...
            body:
              "Hypothesis: a clear \"Specialties\" label on the provider profile header helps patients see what a provider actually treats.\n\nIt worked. Across 6 interviews, net sentiment climbed from −2, where people skimmed past the key information unsure what the provider did, to +15, where they engaged with the provider's experience right away. A 17-point gain, and it shipped.",
          },
          {
            label: "H2",
            title: "Filter Shift",
          ...
          },
          {
            ...
            body:
              "Hypothesis: surfacing a provider's published research on the profile card builds trust. Our web team lead championed it.\n\nThen it scored −21 across 6 interviews. Patients ignored the widget, and where they did notice it, the clinical language bred confusion and chipped at the very trust it was supposed to earn. We killed it before engineering spent a sprint.",
          },
        ],
      },
      {
        ...
        statsTop: true,
        stats: [
          { value: "1 sprint", label: "of front-end development saved by not building it" },
          { value: "−21Δ", label: "the score that made the call hard to argue with" },
        ],
        body:
        ...
        learnings: [
          {
            ...
            visual: "direction",
            body: "Somewhere on every product team sits a feature one person swears by and users don't need. A scored framework catches it before engineering spends a sprint.",
          },
          {
            title: "Decisions that stick",
            visual: "decision",
            body: "Give leadership a number instead of a theme or a quote, and research starts steering direction. Buy-in gets easier to win and harder to walk back.",
          },
          {
            title: "Data that compounds",
            visual: "compounding",
            body: "With a relational research architecture, every study makes the next one smarter. You build on institutional memory instead of starting each project from zero.",
          },
        ],
      },
    ],
    ...
    impactStats: [
      { value: "+17Δ", label: "net sentiment swing on the redesigned provider profile (−2 → +15, H1 shipped)" },
      ...
      { value: "658K", label: "provider-profile views a quarter on the experience I redesigned (New York State users)" },
    ],
  },
  {
    ...
    sections: [
      {
        ...
        body:
          "We had a design system. It had just stopped being the source of truth. Developers shipped small, ad-hoc fixes, each one simple and harmless on its own, and over time those little decisions drifted out of sync until nobody trusted the library anymore.\n\nThe big-ticket widgets held up fine. The small stuff fell apart, the bits and pieces the original system had never really accounted for.\n\nI found the shape of it by auditing what we already had. Our entire library lived on one sprawling board, hard to parse, disorganized, missing the very components the site ran on every day. Everything we needed sat crammed into a single screenshot. The evidence pointed past another patch, toward a new foundation.",
        bullets: [
      ...
      },
      {
        ...
        cards: [
          ...
          {
            title: "Loss of trust",
            body: "A medical portal that looks fragmented quietly tells patients the institution behind it is, too.",
          },
        ],
      },
      {
        ...
        flow: [
          {
            ...
            tag: "I owned",
            owned: true,
            body: "I started with the developers rather than the components. They showed me why the old library had failed: it covered the big widgets but never the small pieces teams reached for, so trust in it eroded. One comprehensive source of truth would fix that; a longer component list wouldn't.",
          },
          {
            step: "02",
            ...
            tag: "I owned",
            owned: true,
            body: "I rebuilt the foundation and defined the full token set, from type and color through grid, spacing, iconography, animation, borders, and shadows. Drift stops at the root now: the small pieces inherit from one source instead of getting hand-styled on every page.",
          },
          {
            step: "03",
            ...
            tag: "Collaboration",
            owned: false,
            body: "I built every component alongside the developers, never across a handoff wall. When something couldn't be built cleanly, the design gave way. That habit earned the system enough trust to be adopted, and it cut review time once work reached handoff.",
          },
        ],
      },
      {
    ...
    impactStats: [
      ...
      { value: "70", label: "components shipped, all now in production across the site" },
      { value: "40-50%", label: "fewer review comments on design docs once teams had what they needed up front" },
    ],
    reflection: [
      {
  ...
  },
  {
    ...
    impactStats: [
      ...
      { value: "66%", label: "would switch supermarkets to use Meal Tab" },
...
// Home grid and case-study "next project" navigation render in this order: lead
// with the strongest, most defensible work (the research framework), not the
// unshipped concept. The raw `projects` array order is not relied on for display.
...
export const orderedProjects: Project[] = displayOrder
