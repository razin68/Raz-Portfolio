...
// All content below is drawn from Ahmed Razin's portfolio and resume.
// The employer is intentionally anonymized as "an academic medical center."
export const projects: Project[] = [
  {
    ...
    role: "UX Designer",
    team: ["1 UX Lead", "2 Developers", "1 Product Manager"],
    owned: [
      "Research synthesis",
    ...
    sections: [
      {
        ...
        pullQuotes: [
          {
            tag: "Out of date",
            text: "The graduate handbook was very out of date, and so was the site: info on current students, past graduates' work, faculty research. I ended up digging outside the website to feel ready to apply.",
            role: "Epidemiology PhD",
          },
          {
            tag: "Reaching real people",
            text: "The information was inconsistent and outdated, like professors who were no longer accepting applications. I reached out to former students to really understand the program.",
            role: "Medical Pharmacology Master's",
          },
          {
            tag: "Connection matters",
            text: "Just doing research isn't enough, you really need to connect on a personal level with colleagues and mentors.",
            role: "Immunology Master's",
          },
        ],
      },
      {
        ...
        visual: "audit",
        body:
          "Here's the deeper problem. The site reads like an institution talking at you: official, polished, a little corporate. A prospective student trying to picture their actual life here has to dig for it. The pieces of a real student's story do exist, but they sit scattered and buried across a sea of official pages: financial aid, admissions, curriculum, location, faculty access. Anything human, like student perspectives or personal growth, takes real effort to find.\n\nSo getting to know a student feels disconnected. You can learn the requirements and the tuition long before you ever hear what it's actually like to be there.",
        bullets: [
      ...
      },
      {
        ...
        body:
          "Students kept leaving the site to find real voices. So I brought the voices to them. Not on one buried \"student life\" page, but woven into the program pages, the PhD directory, and the homepage, right where someone is weighing whether this place is for them.\n\nHere's what makes it work. Every widget pulls from a single content entry. An editor writes one student's story once. The CMS then relates that content to whatever format the page calls for. Tight layout? Drop in a quote. Room to breathe? Run the full feature. Showcasing a cohort? Compose several students into one tabbed block.\n\nWrite the story once. Reuse it anywhere. That's what lets the pattern scale across 250+ programs without an editor rewriting a word, and it's why a human voice can finally show up on the pages that decide enrollment.",
        widgetGrid: [
          {
            image: "/projects/student-voice-system/widget-quote.png",
            heading: "Quote widget",
            useCase:
          ...
          {
            image: "/projects/student-voice-system/widget-featured-light.png",
            heading: "Featured story, light",
            useCase:
          ...
          {
            image: "/projects/student-voice-system/widget-featured-dark.png",
            heading: "Featured story, solid color",
            useCase:
          ...
          {
            image: "/projects/student-voice-system/widget-tabbed.png",
            heading: "Tabbed multi-student",
            useCase:
      ...
      },
      {
        ...
        body:
          "The widgets needed a home. The Student Perspectives page was the obvious first one to fix. It listed a handful of students as walls of essay text, three or four screens of it per person, with one small photo and nothing to anchor a quick scan. A prospective student had to commit to reading before they knew whose story it even was.\n\nThe redesign turns that page into a feed. Each student gets a card: photo, name and program, a short preview, and a link into the full story. The same Perspectives Feed widget powers it, so adding a student is one content entry, not a hand-built page.",
        bullets: [
        ...
        beforeAfter: {
          title: "Old → New: the Student Perspectives page.",
          before: {
            image: "/projects/student-voice-system/student-perspectives.jpg",
      ...
      },
      {
        ...
        body:
          "The PhD directory had the same problem one level up. It led with a dense \"Why Choose Rochester?\" block and a long list of programs, then buried award recipients in paragraphs at the bottom. A prospective student had to read through the institution before they found a single program, let alone a person.\n\nThe redesign rebuilds the page around discovery. A short intro and a \"Why Choose Us?\" video set the tone, every program becomes a scannable card, and a Student Spotlight entry point lands in the main navigation so student voice is a first-class destination, not a footnote. Same content the directory already had, organized so people can actually find their way in.",
        bullets: [
        ...
        beforeAfter: {
          title: "Old → New: the PhD directory.",
          before: {
            image: "/projects/student-voice-system/phd-programs.jpg",
      ...
      },
      {
        ...
        body:
          "The deeper pages were fixed. The last move was the front door. The School of Medicine homepage is where most prospective students arrive first, and it opened on a centennial banner and a dean's portrait, institution before people.\n\nThe redesign keeps the credibility markers but makes room for the students. \"Inside the Trainee Experience\" features a real graduate, a quote widget carries her voice, and the research funding and faculty numbers still anchor the page. This is the toolkit at full reach: the same student entries written for the program pages, now surfaced on the page that sees the most eyes, with no extra authoring.",
        bullets: [
    ...
    impactBody:
      "This never reached production. Alignment across teams stalled it before a build, and I'd be selling you a story to claim adoption numbers it never earned.\n\nWhat held up was the thinking. The content model solved the real constraint, which was never how to design a testimonial. It was how to keep student voice maintainable across 250+ programs without an editor rewriting a word. The research stands on its own. The component logic is sound. The documentation meant the pattern could be built without me in the room. That foundation is what carried forward.",
    reflection: [
      {
        title: "Design the stakeholder alignment in parallel",
        body:
      ...
      {
        title: "Ship something first, design the system second",
        body:
  ...
  },
  {
    ...
    problem:
      "Patients struggled to find and evaluate the right provider, and the team had no reliable way to tell which fixes would actually help, so changes were made on opinion.",
    solution:
      "I redesigned provider search and profiles through three tested hypotheses, powered by a weighted-scoring research framework (Sentiment × Severity) I built to decide what shipped. Two changes shipped; one was killed before a sprint was spent.",
    role: "UX Designer",
    team: ["1 UX Lead", "2 Developers", "1 Product Manager"],
    owned: [
      "Scoring methodology",
    ...
    outcomes: [
      "Increased provider search comprehension by 275%",
    ...
    sections: [
      {
        ...
        body:
          "When I joined the web team at an academic medical center, design decisions ran on opinion. Research happened, but nothing turned it into proof a roadmap would move for. Everyone agreed research mattered. Proving a hypothesis well enough to change direction was the part nobody had solved.\n\nThree things kept getting in the way.",
        cards: [
          {
            title: "Decisions by Opinion",
            lead: "Stakeholder decisions were driven primarily by:",
            points: [
            ...
            note: "\"I don't like the blue\" drove product direction.",
          },
          {
            title: "Limited Pushback Ability",
            body:
              "With little meaningful evidence, every request from leadership carried equal weight, and feature prioritization became subjective.",
            note: "Good instincts and bad ones looked the same.",
          },
          {
            title: "No Organizational Memory",
            body:
              "Every project started from zero. Teams revisited the same usability problems again and again.",
            note: "Insights from past sessions were buried in documents nobody reopened.",
          },
        ],
      },
      {
        ...
        statsTop: true,
        body:
          "The provider search redesign was the first real test, and the reason the framework exists. The team kept proposing fixes nobody could prove. I needed to validate or reject each assumption with evidence, not opinion.\n\nOld research handed over themes and quotes: easy to argue with, impossible to rank. The framework turns each session into a number instead.\n\nWEIGHTED IMPACT SCORE = Sentiment × Severity\n\nSentiment is direction, from −3 to +3: did this help the user or hurt them? I read it from the whole interview, tone, expression, body language, where someone hesitates, not just the words. Severity is how much it mattered, from 1 to 3. Multiply them and every observation carries one weighted score, rolled up to the hypothesis it tested.",
        flow: [
          {
            step: "01",
            title: "Observation Logging",
            body: "Every user behavior, reaction, and comment is logged as a discrete observation.",
          },
          {
            step: "02",
            title: "Taxonomy Coding",
            body: "Observations are tagged against a 27-code taxonomy to cut interpretation drift between studies.",
          },
          {
            step: "03",
            title: "Severity Scoring",
            body: "Each observation gets a sentiment score (−3 to +3) and a severity score (1 to 3), multiplied into a weighted impact score.",
          },
          {
            step: "04",
        ...
        pullQuotes: [
          {
            tag: "Sentiment +1 × Severity 2 = +2",
            tone: "positive",
            text: "To me, non-surgical stands out right here. It says herniated discs, spinal stenosis, degenerative disc disease.",
            role: "Said leaning in, scanning the profile with a nod. Positive direction, moderate weight: a clear point in the hypothesis's favor.",
          },
          {
            tag: "Sentiment 0 = 0",
            tone: "neutral",
            text: "The provider's specialties did not immediately stand out for assessing the profile at a high level.",
            role: "Flat tone, no strong reaction either way. It goes on the record, but it doesn't move the hypothesis.",
          },
          {
            tag: "Sentiment −1 × Severity 1 = −1",
            tone: "negative",
            text: "I'm sort of missing the baseline definition of what orthopedics and physical performance is.",
            role: "Hesitation and a furrowed brow gave this away as a genuine miss. Negative sentiment pulls the hypothesis's score down instead of hiding inside a transcript.",
          },
        ],
        stats: [
          { value: "268", label: "user observations logged" },
          { value: "11", label: "participants" },
          { value: "3", label: "distinct audiences" },
        ],
      },
      {
        ...
        body:
          "With the framework running, I tested three design hypotheses against a documented baseline, each across 6 moderated user interviews. Every hypothesis produced a numeric Efficacy Delta that went straight to the roadmap: two to build, one to kill before a sprint was spent.",
        hypotheses: [
          {
            label: "H1",
            ...
            body:
              "Hypothesis: a clear \"Specialties\" label on the provider profile header helps patients see what a provider actually treats.\n\nIt landed. Across 6 interviews, sentiment swung from −2 (skimming past key information, unsure what the provider did) to +15 (immediately engaged with the provider's experience): a 275% lift in comprehension. Shipped.",
          },
          {
            label: "H2",
            title: "Filter Shift",
            ...
            body:
              "Hypothesis: renaming the filter to match how patients actually talk, and opening it by default, drives more use.\n\nThe dashboard loved it: +18.6% clicks. But across 6 interviews, sentiment only nudged to +2. I triangulated both signals in Looker Studio and presented one unified read that caught a false positive the analytics alone would have called a win. Shipped, with eyes open. The divergence was the finding.",
          },
          {
            label: "H3",
            title: "Connected Profiles",
            verdict: "Killed",
            image: "/projects/ux-research-framework/research-widget.png",
            imageTransparent: true,
            stat: {
              value: "−21Δ",
              label: "sentiment across 6 interviews",
            },
            body:
              "Hypothesis: surfacing a provider's published research on their profile card builds patient trust. It was already approved for development.\n\nAcross 6 interviews it scored −21. People didn't click the widget, and it created confusion that actively undermined trust. The framework killed it before engineering spent a single sprint.",
          },
        ],
      },
      {
        ...
        body:
          "The framework's real payoff showed up after the provider study. Because every session is scored and stored in one relational base, old research stops being a finished report and becomes data I can query again. So I ran the framework backwards over interviews from earlier projects: same sessions, sharper lens, defensible new insight out of work everyone had already filed away.",
        reframes: [
          {
            tag: "Education",
            before:
            ...
            stat: { value: "6 of 8", label: "participants hit the same navigation problem" },
          },
          {
            tag: "Hospitals",
            before:
            ...
            stat: { value: "5,500+", label: "survey recipients, plus 5 moderated interviews" },
          },
        ],
      },
      {
        title: "Key Learnings",
        body:
          "Whether you're building a platform for construction businesses or a healthcare product at institutional scale, the problem is the same: design decisions get made on opinion until you build the infrastructure to make them on evidence.",
        learnings: [
          {
            title: "The right direction",
            visual: "direction",
            body: "Every product team has a feature someone is confident about that users don't need. A scored framework catches it before engineering spends a sprint.",
          },
          {
            title: "Decisions that stick",
            visual: "decision",
            body: "When leadership can see a number, not just a theme or a quote, research becomes a direction mechanism. Buy-in gets easier to win and harder to reverse.",
          },
          {
            title: "Data that compounds",
            visual: "compounding",
            body: "A relational research architecture means every study makes the next one smarter. You add to a system with institutional memory instead of starting from zero.",
          },
        ],
      },
    ],
    impactBody:
      "Design decisions get made on opinion until you have the infrastructure to make them on evidence. I've built that infrastructure, and it works at any scale.",
    impactStats: [
      { value: "275%", label: "increase in provider search comprehension (H1, shipped)" },
      { value: "2 shipped, 1 killed", label: "hypotheses resolved on evidence, not opinion" },
      { value: "268", label: "observations scored across 11 participants and 3 audiences" },
    ],
  },
  {
    ...
    cover: "/projects/healthcare-design-library/cover.jpg",
    problem:
    ...
    sections: [
      {
        ...
        body:
          "We had a design system. It just wasn't the source of truth anymore. Developers shipped small, ad-hoc fixes because each one looked simple and harmless on its own. Over time those little decisions drifted out of sync with the system, the inconsistencies compounded, and eventually nobody treated the library as the source of truth.\n\nThe big-ticket widgets held up. It was the small stuff that fell apart, the bits and pieces the original system never really accounted for.\n\nI found it by auditing what we already had. The whole library lived on one sprawling board: hard to parse, disorganized, and missing the small components the site actually ran on. Everything the site needed was crammed into a single screenshot. That was the evidence: we didn't need another patch, we needed a new approach.",
        bullets: [
      ...
      },
      {
        ...
        cards: [
          {
            title: "High-stakes search friction",
            body: "Broken patterns force patients to spend more time finding care than receiving it.",
          },
          {
            title: "Slow feature release",
            body: "Work piles up, and users wait longer for pressing bug fixes or feature updates.",
          },
          {
            title: "Loss of trust",
            body: "When a medical portal looks fragmented, it erodes the perceived professionalism of the institution.",
          },
        ],
      },
      {
        ...
        flow: [
          {
            ...
            tag: "I owned",
            owned: true,
            body: "I started with the developers, not the components. They showed me why the old library had failed: it covered the big widgets but never the small pieces teams reached for, so it had stopped being trusted. The fix wasn't more components, it was one comprehensive source of truth.",
          },
          {
            step: "02",
            ...
            tag: "I owned",
            owned: true,
            body: "I rebuilt the foundation and defined the full token set: type, color, grid, spacing, iconography, animation, borders, and shadows. This stops drift at the root. The small pieces now inherit from one source instead of being hand-styled on every page.",
          },
          {
            step: "03",
            ...
            tag: "Collaboration",
            owned: false,
            body: "I built every component alongside developers, not across a handoff wall. If something couldn't be built cleanly, the design changed. That's what made the system trustworthy enough to adopt, and it cut review time after handoff.",
          },
        ],
      },
      {
        ...
        body:
          "Most design systems document the big components and stop there. What distinguishes this one is that every widget, down to the small pieces that used to drift, gets the same rigorous documentation, so developers and content editors can act without pulling each other off real work.\n\nEvery widget answers the same six questions. That consistency is what turned the library from a liability into something the team actually reached for, and it moved reviews from \"I don't like the blue\" to \"does this serve what the patient needs?\"",
      },
      {
    ...
    impactStats: [
      { value: "<3 mo", label: "end-to-end delivery, from audit to adoption" },
      {
        value: "1.2M",
        label: "patients served annually by the digital experiences the system supported",
      },
      { value: "70", label: "production-ready components documented, synced, and shipped" },
    ],
    reflection: [
      {
